...
try:
    ...
    print 'raised an exception for some_other_var'
...
try:
    ...
    print 'raised exception for li[4]'
...
filled_set = set([1, 2, 2, 3, 4])   # => {1, 2, 3, 4}
...
def beg(target_function):
    ...
    def wrapper(*args, **kwargs):
        ...
        if say_please:
#            return "{0} {1}".format(msg, "Please! I am poor :(")  Original!!
            return "{0} {1}".format(msg, "Please! I am poor :(")
        return msg
