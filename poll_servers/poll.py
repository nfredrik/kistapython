...
def email_sender(input_message, email_to, client):
    ...
    to = email_to
    gmail_user = 'markaduke@gmail.com' ## email of sender account
    gmail_pwd = 'gld&odhoppa2lo' ## password of sender account
...
clients =  {"http://dn.se":"fredrik@gmail.com",
            "http://svd.se":"fredrik.svard@gmail.com" }
